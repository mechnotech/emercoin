...
urlpatterns = [
    ...
    re_path(r'^tech-solutions/?$', views.tech_solutions, name='tech-solutions'),
    re_path(r'^for-business/?$', views.for_business, name='for-business'),
    re_path(r'^for-coinholders/?$', views.for_coinholders, name='for-coinholders'),
    re_path(r'^benefits/?$', views.for_coinholders, name='benefits'),
    re_path(r'^for-developers/?$', views.for_developers, name='for-developers'),
